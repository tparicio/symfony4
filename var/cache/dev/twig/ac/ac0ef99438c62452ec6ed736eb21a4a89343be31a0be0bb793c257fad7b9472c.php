...
class __TwigTemplate_7885bfe5012350dbd0b619f524b9d82ef1a19b4a62e3e6c672279a43cec9d205 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <div class=\"col-12 col-md-12 col-lg-12 pb-12 text-center\">
        <a href=\"";
        // line 7
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("contact_index");
        echo "\">";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("contact.back"), "html", null, true);
        echo "</a>
    </div>
    <!--Form with header-->
...
";
    ...
    {
        return array (  100 => 11,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <div class=\"col-12 col-md-12 col-lg-12 pb-12 text-center\">
        <a href=\"{{ path('contact_index') }}\">{{ 'contact.back' | trans }}</a>
    </div>
    <!--Form with header-->
    <div class=\"col-12 col-md-8 col-lg-6 pb-5\">
...
{% endblock %}
", "contact/new.html.twig", "/var/www/sites/symfony/templates/contact/new.html.twig");
    }
}
